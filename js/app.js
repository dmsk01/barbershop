...
let sliderTest = new Swiper('.blog__slider', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
if (document.querySelector(".gallery__wrapper")) {
  let mySwiper = new Swiper(".gallery__wrapper", {
    loop: true,
    slidesPerView: 1,
    pagination: false,
    navigation: {
...
if (document.querySelector(".js-time-picker")) {
...
let openedMenuLinks = document.querySelectorAll(".menu__link");
...
if (iconMenu != null) {
  ...
  for (let link = 0; link < openedMenuLinks.length; link++) {
    const element = openedMenuLinks[link];
